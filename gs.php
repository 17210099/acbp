                        ...
                        <div class="heading_container">
                            ...
                            <h4>
                                <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                    ...
                                    <option value="gs/gs1.php">1 TERGUGAT</option>
                                    <option value="gs/gs2.php">2 TERGUGAT</option>
                                    <option value="gs/gs3.php">3 TERGUGAT</option>
                                    <option value="gs/gs4.php">4 TERGUGAT</option>
                                    <option value="gs/gs5.php">5 TERGUGAT</option>
                                    <option value="gs/gs6.php">6 TERGUGAT</option>
                                    <option value="gs/gs7.php">7 TERGUGAT</option>
                                    <option value="gs/gs8.php">8 TERGUGAT</option>
                                    <option value="gs/gs9.php">9 TERGUGAT</option>
                                    <option value="gs/gs10.php">10 TERGUGAT</option>
                                    <option value="gs/gs11.php">11 TERGUGAT</option>
                                    <option value="gs/gs12.php">12 TERGUGAT</option>
                                    <option value="gs/gs13.php">13 TERGUGAT</option>
                                    <option value="gs/gs14.php">14 TERGUGAT</option>
                                    <option value="gs/gs15.php">15 TERGUGAT</option>
                                    <option value="gs/gs16.php">16 TERGUGAT</option>
                                    <option value="gs/gs17.php">17 TERGUGAT</option>
                                    <option value="gs/gs18.php">18 TERGUGAT</option>
                                    <option value="gs/gs19.php">19 TERGUGAT</option>
                                    <option value="gs/gs20.php">20 TERGUGAT</option>
