...
<head>
    ...
    <title>ACBP (Aplikasi Cek Panjar Biaya Perkara PN TONDANO)</title>
                                    ...
                                    <div class="detail-box">
                                        ...
                                        <h1>
                                            ...
                                            <span>
                                                ...
                                                <h2> <strong>APLIKASI <span class="greentext">CEK BIAYA PANJAR</span></strong></h2>
                                                <h2> <strong>PENGADILAN NEGERI TONDANO</strong> </h2>
                                                <h2><strong>KELAS 1B</strong></h2>
                                            ...
                                            <p>
                                            <p>
                                                ACBP atau Aplikasi Cek Biaya
                                                Panjar adalah salah satu inovasi
                                                dari Pengadilan Negeri Tondano
                                                yang akan membantu untuk para
                                                Pencari Keadilan agar bisa tahu
                                                besar kecil biaya panjar perkara di
                                                Pengadilan Negeri Tondano
                                                berdasarkan menu yang tersedia.
                                            </p>
                                            </p>
                                            <div class="btn-box">
                                                <a class="btn btn-outline-success-pake-skali my-2 my-sm-0" href="menuhalaman.php">
                                                    AYO CEK BIAYA PERKARA
                                                </a>

                                            </div>
                                            <a><img src="images/berakhlak2.png" width="420" alt=""></a>
                                            <br>
