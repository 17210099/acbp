                            ...
                            <form method="POST">
                                ...
                                <table>
                                    ...
                                    <h5><select class="js-example-basic-single" type="text" name="tergugat">
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat10">
                                            <option value="">Pilih Lokasi Tegugat 10</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat11">
                                            <option value="">Pilih Lokasi Tegugat 11</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat12">
                                            <option value="">Pilih Lokasi Tegugat 12</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat13">
                                            <option value="">Pilih Lokasi Tegugat 13</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat14">
                                            <option value="">Pilih Lokasi Tegugat 14</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat15">
                                            <option value="">Pilih Lokasi Tegugat 15</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat16">
                                            <option value="">Pilih Lokasi Tegugat 16</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat17">
                                            <option value="">Pilih Lokasi Tegugat 17</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat18">
                                            <option value="">Pilih Lokasi Tegugat 18</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat19">
                                            <option value="">Pilih Lokasi Tegugat 19</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
                                        ...
                                        <select class="js-example-basic-single" type="text" name="tergugat20">
                                            <option value="">Pilih Lokasi Tegugat 20</option>
                                            <option strong disabled class="redtext">MINAHASA</option>
