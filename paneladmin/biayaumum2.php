...
<head>
  ...
  <title>Permohonan (Biaya Umum)</title>
...
<body>
          ...
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              ...
              if (isset($_POST['bsimpan'])) {
                ...
                if ($_GET['hal'] == "edit") {
                  //Data akan di edit
                  $edit = mysqli_query($koneksi, "UPDATE permohonan2 SET
		id = '$_POST[tid]',
  ...
  ");
                  if ($edit) //jika edit sukses
                  {
					...
					document.location='biayaumum2.php';
				 </script>";
                  } else {
                    echo "<script>
                  ...
                  $simpan = mysqli_query($koneksi, "INSERT INTO permohonan2 (id, pendaftaran, biayaproses, meterai, redaksi, pnbp)
									  VALUES ('$_POST[tid]',
                          '$_POST[tpendaftaran]',  
                          '$_POST[tbiayaproses]',  
                          '$_POST[tmeterai]',  
              ...
              if (isset($_GET['hal'])) {
                ...
                if ($_GET['hal'] == "edit") {
                  ...
                  $tampil = mysqli_query($koneksi, "SELECT * FROM permohonan2 WHERE id_no = '$_GET[id]' ");
                  ...
                  $hapus = mysqli_query($koneksi, "DELETE FROM permohonan2 WHERE id_no = '$_GET[id]' ");
                  if ($hapus) {
                    echo "<script>
        ...
        <div class="card-body">
          <h3>DATA BIAYA UMUM PERMOHONAN </h3>
          <h4>
            <table id="customers">
              ...
              <?php
              $no = 1;
              $tampil = mysqli_query($koneksi, "SELECT * from permohonan2 order by id_no desc");
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="biayaumum2.php?hal=edit&id=<?= $data['id_no'] ?>" class="btn btn-warning"> Edit </a>
                    <a href="biayaumum2.php?hal=hapus&id=<?= $data['id_no'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')" class="btn btn-danger"> Hapus </a>
                  </td>
                </tr>
