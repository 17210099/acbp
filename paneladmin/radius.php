...
<body>
  ...
  ");
              ...
              <h1>TAMBAH DATA RADIUS</h1>
              <h3>
                <form method="post" action="">
                  <div class="form-group">
                    <label>Radius</label>
                    <input type="number" name="trad" value="<?= @$vrad ?>" class="form-control" placeholder="" required>
                  </div>
                  <div class="form-group">
              ...
              <table id="customers">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="radius.php?hal=edit&id=<?= $data['id_no'] ?>" class="btn btn-warning"> Edit </a>
                      <a href="radius.php?hal=hapus&id=<?= $data['id_no'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')" class="btn btn-danger"> Hapus </a>
                    </td>
                  </tr>
