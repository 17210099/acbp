...
<body class="sub_page">
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat10 = $_POST['tergugat10'];

        $jumlah110 = 0;
        $jumlah_110 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat10' ");
        while ($tabelB = mysqli_fetch_array($jumlah_110)) {
            $dataB = $tabelB['radius']; {

                $jumlah110 = $jumlah110 + $dataB;
                $jumlah110 = $jumlah110 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat11 = $_POST['tergugat11'];

        $jumlah111 = 0;
        $jumlah_111 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat11' ");
        while ($tabelB = mysqli_fetch_array($jumlah_111)) {
            $dataB = $tabelB['radius']; {

                $jumlah111 = $jumlah111 + $dataB;
                $jumlah111 = $jumlah111 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat12 = $_POST['tergugat12'];

        $jumlah112 = 0;
        $jumlah_112 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat12' ");
        while ($tabelB = mysqli_fetch_array($jumlah_112)) {
            $dataB = $tabelB['radius']; {

                $jumlah112 = $jumlah112 + $dataB;
                $jumlah112 = $jumlah112 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat13 = $_POST['tergugat13'];

        $jumlah113 = 0;
        $jumlah_113 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat13' ");
        while ($tabelB = mysqli_fetch_array($jumlah_113)) {
            $dataB = $tabelB['radius']; {

                $jumlah113 = $jumlah113 + $dataB;
                $jumlah113 = $jumlah113 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat14 = $_POST['tergugat14'];

        $jumlah114 = 0;
        $jumlah_114 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat14' ");
        while ($tabelB = mysqli_fetch_array($jumlah_114)) {
            $dataB = $tabelB['radius']; {

                $jumlah114 = $jumlah114 + $dataB;
                $jumlah114 = $jumlah114 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat15 = $_POST['tergugat15'];

        $jumlah115 = 0;
        $jumlah_115 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat15' ");
        while ($tabelB = mysqli_fetch_array($jumlah_115)) {
            $dataB = $tabelB['radius']; {

                $jumlah115 = $jumlah115 + $dataB;
                $jumlah115 = $jumlah115 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat16 = $_POST['tergugat16'];

        $jumlah116 = 0;
        $jumlah_116 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat16' ");
        while ($tabelB = mysqli_fetch_array($jumlah_116)) {
            $dataB = $tabelB['radius']; {

                $jumlah116 = $jumlah116 + $dataB;
                $jumlah116 = $jumlah116 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat17 = $_POST['tergugat17'];

        $jumlah117 = 0;
        $jumlah_117 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat17' ");
        while ($tabelB = mysqli_fetch_array($jumlah_117)) {
            $dataB = $tabelB['radius']; {

                $jumlah117 = $jumlah117 + $dataB;
                $jumlah117 = $jumlah117 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat18 = $_POST['tergugat18'];

        $jumlah118 = 0;
        $jumlah_118 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat18' ");
        while ($tabelB = mysqli_fetch_array($jumlah_118)) {
            $dataB = $tabelB['radius']; {

                $jumlah118 = $jumlah118 + $dataB;
                $jumlah118 = $jumlah118 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat19 = $_POST['tergugat19'];

        $jumlah119 = 0;
        $jumlah_119 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat19' ");
        while ($tabelB = mysqli_fetch_array($jumlah_119)) {
            $dataB = $tabelB['radius']; {

                $jumlah119 = $jumlah119 + $dataB;
                $jumlah119 = $jumlah119 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $tergugat20 = $_POST['tergugat20'];

        $jumlah120 = 0;
        $jumlah_120 = mysqli_query($koneksi, "SELECT * FROM biayagugatan WHERE id_rad = '$tergugat20' ");
        while ($tabelB = mysqli_fetch_array($jumlah_120)) {
            $dataB = $tabelB['radius']; {

                $jumlah120 = $jumlah120 + $dataB;
                $jumlah120 = $jumlah120 * 3;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $putusan1   = $_POST['tergugat'];
        $putusan = 0;
        $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$putusan1' ");
        while ($tabelc = mysqli_fetch_array($jumlah_3)) {
            $datac = $tabelc['putusan']; {

                $putusan = $putusan + $datac;
            }
        }
    ...
    if (isset($_POST['hitung'])) {
        ...
        $pnbp100    = $_POST['tergugat10'];
        $pnbp10 = 0;
        $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp100' ");
        while ($tabelc = mysqli_fetch_array($jumlah_3)) {
            $datac = $tabelc['pnbp']; {
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1001    = $_POST['tergugat11'];
            $pnbp101 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1001' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp101 = $pnbp101 + $datac;
                    $pnbp101 = $pnbp101 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1002    = $_POST['tergugat12'];
            $pnbp102 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1002' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp102 = $pnbp102 + $datac;
                    $pnbp102 = $pnbp102 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1003    = $_POST['tergugat13'];
            $pnbp103 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1003' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp103 = $pnbp103 + $datac;
                    $pnbp103 = $pnbp103 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1004    = $_POST['tergugat14'];
            $pnbp104 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1004' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp104 = $pnbp104 + $datac;
                    $pnbp104 = $pnbp104 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1005    = $_POST['tergugat15'];
            $pnbp105 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1005' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp105 = $pnbp105 + $datac;
                    $pnbp105 = $pnbp105 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1006    = $_POST['tergugat16'];
            $pnbp106 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1006' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp106 = $pnbp106 + $datac;
                    $pnbp106 = $pnbp106 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1007    = $_POST['tergugat17'];
            $pnbp107 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1007' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp107 = $pnbp107 + $datac;
                    $pnbp107 = $pnbp107 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1008    = $_POST['tergugat18'];
            $pnbp108 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1008' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp108 = $pnbp108 + $datac;
                    $pnbp108 = $pnbp108 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1009   = $_POST['tergugat19'];
            $pnbp109 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1009' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp109 = $pnbp109 + $datac;
                    $pnbp109 = $pnbp109 * 2;
                }
            }
        ...
        if (isset($_POST['hitung'])) {
            ...
            $pnbp1020    = $_POST['tergugat20'];
            $pnbp120 = 0;
            $jumlah_3 = mysqli_query($koneksi, "SELECT * FROM biayagugatan2 WHERE id = '$pnbp1020' ");
            while ($tabelc = mysqli_fetch_array($jumlah_3)) {
                $datac = $tabelc['pnbp']; {

                    $pnbp120 = $pnbp120 + $datac;
                    $pnbp120 = $pnbp120 * 2;
                }
            }
    ...
    <body>
        ...
        Pengadilan Tondano mencakup 1 Kota dan 2 Kabupaten yaitu Kota Tomohon, Kabuptaen Minahasa, dan Kabupaten Minahasa Tenggara.
        jika lokasi tidak ada dalam kolom ataupun lokasi tergugat berada di luar jangkauan Pengadilan Negeri Tondano silahkan datang langsung bertanya di tempat.
        <br>
        <br>
        <h2>Silahkan Pilih Lokasi yang ingin di Cek biayanya</h2>
        <h5 class="redtext">Berhubung pendaftaran melalui aplikasi E-Court maka biaya panggilan Kepada Penggugat hanya melalui panggilan email, maka tidak ada biaya panggilan untuk Penggugat</h5>
        <form method="POST">
            <table>
                <tr>
                    <td>Tergugat 1</td>
                    <td>:</td>
                    <td><select class="js-example-basic-single" type="text" name="tergugat">
                ...
                <tr>
                    <td>Tergugat 2</td>
                    <td>:</td>
                    <td><select class="js-example-basic-single" type="text" name="tergugat2">
                            <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 3</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat3">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 4</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat4">
                        <option value="">Pilih Lokasi</option>
                    ...
                    <tr>
                        <td>Tergugat 5</td>
                        <td>:</td>
                        <td><select class="js-example-basic-single" type="text" name="tergugat5">
                                <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 6</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat6">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 7</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat7">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 8</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat8">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 9</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat9">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 10</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat10">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 11</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat11">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 12</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat12">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 13</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat13">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 14</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat14">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 15</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat15">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 16</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat16">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 17</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat17">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 18</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat18">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 19</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat19">
                        <option value="">Pilih Lokasi</option>
                ...
                <td>Tergugat 20</td>
                <td>:</td>
                <td><select class="js-example-basic-single" type="text" name="tergugat20">
                        <option value="">Pilih Lokasi</option>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="submit" href="tabel.php" class="cekbiaya" name="hitung" value="CEK BIAYA">
