    ...
    <body>
        ...
        <form method="post" action="hitung1.php">
            <table id="customers">
                ...
                <tr>
                    <td> Biaya Tergugat Panggilan/Pembritahuan/PMH (5x)</td>
                    <td><?php echo buatRupiah(@$jumlah2); ?></td>
                ...
                <tr>
                    ...
                    <td>
                        <strong><?php echo buatRupiah(@$jumlah2 + @$pendaftaran + @$biayaatk + @$meterai + @$redaksi + @$pnbp); ?>
                    </td>
                    <td></td>
                    </strong>
                </tr>
