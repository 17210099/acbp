    ...
    <section class="animal_section layout_padding">
        <div class="container">
            <div class="animal_container">
                <div class="box">
                    <div class="img-box">
                        <a href="gugatan.php"><img src="images/gugatan.png" alt="">
                    </div></a>
                ...
                <div class="box">
                    <div class="img-box">
                        <a href="permohonan.php"><img src="images/permohonan.png" alt="">
                    </div></a>
                    <div class="detail-box">
                        <h5>
                            Permohonan
                ...
                <div class="box">
                    <div class="img-box">
                        <a href="gs.php"><img src="images/gugatansederhana.png" alt="">
                    </div></a>
                    <div class="detail-box">
                        <h5>
                            Gugatan Sederhana
                ...
                <div class="box">
                    <a href="cerai/cerai.php">
                        <div class="img-box">
                            <img src="images/gugatancerai.png" alt="">
                        </div>
                    </a>
                    <div class="detail-box">
                        <h5>
                ...
                <div class="box">
                    <div class="img-box">
                        <a href="https://ecourt.mahkamahagung.go.id/"><img src="images/e-court.png" alt="">
                    </div></a>
                    <div class="detail-box">
                        <h5>
                            e-Court
                ...
                <div class="box">
                    <div class="img-box">
                        <a href="http://wa.me/6285163088505"><img src="images/ptsponline.png" alt="">
                    </div></a>
                    <div class="detail-box">
                        <h5>
                            PTSP Online
