...
<body class="sub_page">
  ...
  <body>
    ...
    <h5 class=redtext>Berhubung pendaftaran melalui aplikasi E-Court maka biaya panggilan Kepada Pemohon hanya melalui panggilan email, maka tidak ada biaya panggilan untuk Pemohon</h5>
    <br>
    <form method="POST">
      <table>
        <tr>
          <td>Pemohon</td>
          <td>:</td>
          <td><select class="js-example-basic-single" type="text" name="pemohon">
